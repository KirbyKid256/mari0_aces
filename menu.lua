	...
	if gamestate == "menu" then
		...
		for i = start, 9 do
			...
			if continueavailable then
				if i == 9 then if not selectworldopen and mouseonselecthold and mouseonselect == 0 then love.graphics.setColor(188, 188, 188) else love.graphics.setColor(255, 255, 255) end end
				properprintfunc(TEXT["continue game"], (143-(math.ceil(utf8.len(TEXT["continue game"])/2)*8))*scale, 122*scale)
			end
			
			if i == 9 then if not selectworldopen and mouseonselecthold and mouseonselect == 1 then love.graphics.setColor(188, 188, 188) else love.graphics.setColor(255, 255, 255) end end
			...
			if i == 9 then if (not selectworldopen and mouseonselecthold and mouseonselect == 2) or nofunallowed then love.graphics.setColor(188, 188, 188) else love.graphics.setColor(255, 255, 255) end end
			properprintfunc(TEXT["level editor"], (143-(math.ceil(utf8.len(TEXT["level editor"])/2)*8))*scale, 154*scale)
			
			if i == 9 then if not selectworldopen and mouseonselecthold and mouseonselect == 3 then love.graphics.setColor(188, 188, 188) else love.graphics.setColor(255, 255, 255) end end
			properprintfunc(TEXT["select mappack"], (143-(math.ceil(utf8.len(TEXT["select mappack"])/2)*8))*scale, 170*scale)
			
			if i == 9 then if not selectworldopen and mouseonselecthold and mouseonselect == 4 then love.graphics.setColor(188, 188, 188) else love.graphics.setColor(255, 255, 255) end end
...
function createmappack()
	...
	love.filesystem.remove("saves/" .. mappack .. ".suspend")
end
...
function newgame()
	if love.filesystem.getInfo("saves/" .. mappack .. ".suspend") then
		newgamewarning = true
		newgamewarningcursor = 1
		return
	end
